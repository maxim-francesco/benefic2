...
export function CarCard({ car, index }: { car: CarProps; index: number }) {
  return (
    <motion.div
      ...
      className="group flex flex-col bg-white rounded-2xl overflow-hidden border border-navy-100 hover:border-navy-200 hover:shadow-lg hover:shadow-navy-800/10 transition-all duration-[350ms] ease-out hover:-translate-y-2 cursor-pointer h-full"
    >
