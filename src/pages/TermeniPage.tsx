    ...
    <>
      ...
      >
        ...
        <div className="font-body text-navy-600 leading-relaxed space-y-6">
          <p>
            Bine ați venit pe site-ul Benefic Cars. Vă rugăm să citiți cu atenție acești termeni și condiții înainte de a utiliza serviciile noastre.
          </p>

          <h2 className="font-display font-semibold text-navy-700 text-xl mt-8 mb-3">1. Date de identificare</h2>
          <p>
            Site-ul beneficcars.ro este administrat de BENEFIC CAR S.R.L., cu sediul în [COMPLETATI ADRESA], înregistrată la Registrul Comerțului sub nr. [COMPLETATI REG. COM.], CUI [COMPLETATI CUI].<br/>
            Email: <a href="mailto:contact@beneficcars.ro" className="text-mauve-600 hover:text-mauve-500 underline">contact@beneficcars.ro</a><br/>
            Telefon: <a href="tel:+40700000000" className="text-mauve-600 hover:text-mauve-500 underline">+40 700 000 000</a>
          </p>
          ...
          <p>
            Ne rezervăm dreptul de a corecta eventuale omisiuni sau erori afișate din greșeală pe platformă. Textele, imaginile, sigla și conceptul website-ului aparțin BENEFIC CAR S.R.L. și nu pot fi copiate fără un acord explicit.
          </p>

          <h2 className="font-display font-semibold text-navy-700 text-xl mt-8 mb-3">8. Legislație și Instanța Competentă</h2>
          <p>
            Orice litigiu izvorât din utilizarea platformei noastre va fi soluționat amiabil, iar dacă acest lucru nu este posibil, competența revine instanțelor judecătorești românești de la sediul BENEFIC CAR S.R.L.
          </p>
        </div>
      </motion.div>
    </main>
